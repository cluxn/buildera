      ...
      <div className="relative container mx-auto px-8 max-w-7xl">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground mb-10 leading-relaxed max-w-2xl">
            Buildera is a global IT services company helping businesses replace manual processes and
            legacy systems with custom software that actually fits the way they work. We&apos;ve shipped
            800+ projects across 6 service lines since 2018.
          </p>

          {/* Trust badge strip */}
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-muted-foreground">
            <span className="font-medium text-foreground">800+ Projects Delivered</span>
            <span aria-hidden="true" className="text-border">|</span>
            <span className="font-medium text-foreground">500+ Active Clients</span>
            <span aria-hidden="true" className="text-border">|</span>
            <span className="font-medium text-foreground">10+ Years Experience</span>
          </div>
        </div>
      </div>
    </section>
