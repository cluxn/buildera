      ...
      <div className="container mx-auto px-8 max-w-7xl">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 rounded-lg bg-white/10 text-white font-semibold text-base border border-white/25 hover:bg-white/20 transition-colors"
            >
              Send a Message
            </Link>
          </div>
